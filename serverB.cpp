...
int main() {
    int sockfd;
    char buffer[MAXLINE];
    char *hello = "Hello from server B";
    ...
    socklen_t len;
    string save;
    cout<<"The ServerB is up and running using UDP on port 22270."<<endl;
