...
int main() {
    int sockfd;
    char buffer[MAXLINE];
    char *hello = "Hello from server A";
    ...
    socklen_t len;
    string save;
    cout<<"The ServerA is up and running using UDP on port 21270."<<endl;
